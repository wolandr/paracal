...
var opt struct {
	...
	Layout string         `short:"l" long:"layout" choice:"left" choice:"right" choice:"bottom" choice:"top" choice:"square" choice:"square_h" description:"Calendar layout" default:"left"`
...
func main() {
	...
	internal.Draw(f, opt.Year, opt.Month, internal.LayoutType(opt.Layout), *style, opt.Back)
}
